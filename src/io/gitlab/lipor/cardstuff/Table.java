...
import io.gitlab.lipor.cardstuffExceptions.HandException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalBigblindException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalButtonPositionException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalCardCountException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalGametypeException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalPokerroomException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalPotsizeException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalRakesizeException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalSeatCountException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalSeatException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalSmallblindException;
import io.gitlab.lipor.cardstuffExceptions.HandIllegalTabletypeException;
import io.gitlab.lipor.cardstuffExceptions.HandMissingNameException;
import io.gitlab.lipor.cardstuffExceptions.HandPositionEmptyException;
import io.gitlab.lipor.cardstuffExceptions.HandPositionNotEmptyException;
import io.gitlab.lipor.cardstuffExceptions.HandToMuchPlayersException;
...
import io.gitlab.lipor.cardstuffExceptions.PlayerMissingException;
...
public class Table {
	 ...
	 * Konstanten
	 **************************************************************************/
	public static final int WIN2DAY = 1;
	...
	private Player lastActionsPlayer = null;
...
//		df.format( dt );
	...
	public void setLastActionsPlayer(Player player) {
		this.lastActionsPlayer = player;
	}
	
	public Player getLastActionsPlayer() {
		return lastActionsPlayer;
	}
}
