...
import io.gitlab.lipor.cardstuffExceptions.ActionMissingParameterException;
...
public class Action {
	...
	public String toString() {
		...
		case SHOWDOWN:
			...
			break;
		case UNCALLED_BET:
			ret = Messages.Action_15 + String.valueOf(value) + Messages.Action_16 + player.getName() + Messages.Action_17;
			break;
		default:
			ret = Messages.Action_18;
			break;
		}
		return ret;
	}
	...
	private void checkDependency(int action, Player player, Object value) throws ActionMissingParameterException {
		...
		case MUCK:
			if (player == null) {
				throw new ActionMissingParameterException(Messages.Action_19);
			}
			break;
		case SHOW:
