...
import net.sourceforge.rjPokerReplay.cardstuff.Card;
import net.sourceforge.rjPokerReplay.cardstuff.Hand;
import net.sourceforge.rjPokerReplay.cardstuff.Handhistory;
import net.sourceforge.rjPokerReplay.cardstuff.Player;
				...
				do {
					...
					if (handStep > 0 && hand != null) {
						try {
							...
							ErrorHandler.handleError(e, Messages.ViewTable_21,
									false);
						}
					}
					try {
						...
						ErrorHandler.handleError(e,
								Messages.ViewTable_22, false);
					} catch (ActionIllegalActionException e) {
						ErrorHandler.handleError(e,
								Messages.ViewTable_23, false);
					}
