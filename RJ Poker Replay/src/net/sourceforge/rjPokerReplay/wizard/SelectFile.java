...
import net.sourceforge.rjPokerReplay.util.FileUtil;
...
public class SelectFile extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		try {
			...
			bWaehlen.setImage(ApplicationWorkbenchAdvisor.getImageStore().get(net.sourceforge.rjPokerReplay.Constants.IMG_OPEN_FOLDER));
		} catch (Exception e) {
